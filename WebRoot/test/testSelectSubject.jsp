			...
			<div class="modal-body"
				...
				<form class="form-horizontal" role="form" action="">
						...
						<div>
							<div class="col-md-4">
								<label><input type="checkbox" value="计算机基础及WPS Office应用"
									name="checkBox1" onclick="selectSubject(this)">计算机基础及WPS Office应用</label>
							</div>
							<div class="col-md-4">
								<label><input type="checkbox" value="计算机基础及MS Office应用"
									name="checkBox1" onclick="selectSubject(this)">计算机基础及MS Office应用</label>
							</div>
							<div class="col-md-4">
					...
					<div class="form-group">
						<div>
							<div class="col-md-4">
								<label><input type="checkbox" value="网络技术" name="checkBox1"
									onclick="selectSubject(this)">网络技术</label>
							</div>
							<div class="col-md-4">
								<label><input type="checkbox" value="数据库技术" name="checkBox1"
									onclick="selectSubject(this)"> 数据库技术</label>
							</div>
							<div class="col-md-4">
								<label><input type="checkbox" value="信息安全技术" name="checkBox1"
									onclick="selectSubject(this)">信息安全技术</label>
							</div>
						</div>
						<div class="col-md-12">
							<label><input type="checkbox" value="嵌入式系统开发技术" name="checkBox1"
								onclick="selectSubject(this)">嵌入式系统开发技术</label>
						</div>
					</div>
					<div class="modal-header"></div>
					<div style="text-align: left;">
					...
					<div class="form-group">
						<div>
							<div class="_18">
								<label><input type="checkbox" value="网络工程师" name="checkBox1"
									onclick="selectSubject(this)">网络工程师</label>
							</div>
							<div class="col-md-4">
								<label><input type="checkbox" value="数据库工程师" name="checkBox1"
									onclick="selectSubject(this)">数据库工程师</label>
							</div>
							<div class="col-md-4">
								<label><input type="checkbox" value="信息安全工程师" name="checkBox1"
									onclick="selectSubject(this)">信息安全工程师</label>
							</div>
						</div>
						<div class="col-md-12">
							<label><input type="checkbox" value="嵌入式系统开发工程师" name="checkBox1"
								onclick="selectSubject(this)">嵌入式系统开发工程师</label>
						</div>
					</div>
